...
Transform1 = Join.apply(frame1 = DataSource0, frame2 = Transform0, keys2 = ["(stats) idfixture", "(stats) idhometeam", "(stats) idawayteam"], keys1 = ["idfixture", "idhometeam", "idawayteam"], transformation_ctx = "Transform1")
## @type: ApplyMapping
