...
## @type: ApplyMapping
## @args: [mappings = [("idfixture", "long", "idfixture", "long"), ("idawayteam", "long", "idteam", "long"), ("goalsawayteam", "long", "goals", "long"), ("shotsongoalawayteam", "long", "shotsongoal", "long"), ("shotsinsideboxawayteam", "long", "shotsinsidebox", "long"), ("totalshotsawayteam", "long", "totalshots", "long"), ("ballpossessionawayteam", "string", "ballpossession", "string")], transformation_ctx = "Transform2"]
## @return: Transform2
## @inputs: [frame = Transform1]
Transform2 = ApplyMapping.apply(frame = Transform1, mappings = [("idfixture", "long", "idfixture", "long"), ("idawayteam", "long", "idteam", "long"), ("goalsawayteam", "long", "goals", "long"), ("shotsongoalawayteam", "long", "shotsongoal", "long"), ("shotsinsideboxawayteam", "long", "shotsinsidebox", "long"), ("totalshotsawayteam", "long", "totalshots", "long"), ("ballpossessionawayteam", "string", "ballpossession", "string")], transformation_ctx = "Transform2")
